          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="contact-header">
                <h1 className="bg-dark p-3 text-white text-center">
                  Privacy Policy
                </h1>
              </div>
              <div className="contact-info">
                <div className="contact-item">
                  <p>
                    This Privacy Policy outlines our commitment to protecting
                    your personal information and ensuring its confidentiality.
                  </p>
                </div>
                ...
                <div className="contact-item">
                  <p>
                    Rest assured that your information is securely stored and
